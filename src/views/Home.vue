<template>
	<div class="Home">
		...
		<!-- 公告 -->
		<van-notice-bar scrollable left-icon="volume-o" color="#e53333" background="#fff" :text="Notice" />
		<!-- 菜单 -->
        ...
        <p>115分钟1期</p>
			...
			>
				<van-image round width="2.5rem" height="2.5rem" :src="require('../assets/image/'+item.pic)" />
				<p>{{ item.name }}</p>
				<p>{{ item.tip }}</p>
			</van-col>
		</van-grid>
